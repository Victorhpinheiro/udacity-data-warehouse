...
def get_cluster_props(redshift, DWH_CLUSTER_IDENTIFIER):
    ''' Get Redshift clusters properties '''
...
def open_income_port(ec2, myClusterProps, DWH_PORT):
    '''
    Allow access through redshift port
    '''
...
def main():
    ...
    #Sleeps for 3 min after create the cluster to make sure it is available
    # print("Will sleep 340")
    # time.sleep(340)
    # print("Finished sleeping")

    myClusterProps = get_cluster_props(redshift, DWH_CLUSTER_IDENTIFIER)

    open_income_port(ec2, myClusterProps, DWH_PORT)
